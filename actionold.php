...
<body>
	<header style="height: 5vh; margin-top: 1.25vh; padding: 0 5vw;">
		<div id="upper">
			<p style='font-size: 30px; display: inline-block; width: auto; font-family: "Avenir Black"; background: linear-gradient(30deg, #2AFEB7, #5C27FE); -webkit-background-clip: text; -webkit-text-fill-color: transparent;'>Qonyrau</p>
		</div>
	</header>
  ...
  <section class = "content">
		<?php
		 for ($i = 1; $i <= 5; ++$i) {
				echo '
				<div class="card">
				<h3 class="cardTitle">' . $weekNames[$i] . '</h3>
				<div class="cardField">
					<div class="mainMenu">
				';
				for ($j = 1; $j <= $lessCnt[$i]; ++$j) {
